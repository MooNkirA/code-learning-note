...
![image-20221018140238407](images/image-20221018140238407.png)

2. 利用运算符`=`和`&&`（或`||`）级联拼接。就把`&&`（或`||`）连接符拆开，利用运算符`=`和`&&`（或`||`）级联进行拼接。这种方式并不能减少方法的圈复杂度。

![image-20221018140529962](images/image-20221018140529962.png)
...
![image-20221018140636316](images/image-20221018140636316.png)
...
![image-20221018140852798](images/image-20221018140852798.png)
...
![image-20221018150659215](images/image-20221018150659215.png)

2. 对于映射关系的 if-else 语句，可以用 Map 来简化。此外，此规则同样适用于简化映射关系的 switch 语句。

![image-20221018150643615](images/image-20221018150643615.png)
...
![image-20221018170019662](images/image-20221018170019662.png)
