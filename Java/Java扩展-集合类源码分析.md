...
##### 2.5.1.1. JDK 8 为什么要 hashcode 异或其右移十六位的值
...
##### 2.5.1.2. 计算数组下标时为什么要 hash 值与 length-1 相与
...
#### 2.7.3. 解决 hash 冲突的时为什么选择先用链表，再转红黑树
