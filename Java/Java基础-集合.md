...
![Java集合框架图.drawio](images/338213512256809.jpg)

### 2.3. Collection 集合接口的常用方法
...
#### 3.8.3. 集合（List）与数组（Array）的区别与选择
...
#### 3.9.1. ArrayList 和 LinkedList 的区别与选择
...
#### 4.6.4. Iterator 和 ListIterator 的区别(面试题)
...
![Java集合框架图.drawio](images/491795612249478.jpg)
...
#### 7.9.2. SynchronizedMap 和 ConcurrentHashMap 有什么区别
...
### 8.3. Comparator 与 Comparable 的区别
