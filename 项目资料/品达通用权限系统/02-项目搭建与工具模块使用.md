...
> Notes: 权限认证相关的内容详见[《授权认证概述》笔记](/分布式微服务/Authorization-Certification/Authorization-Overview)
...
> Notes: 权限认证相关的内容详见[《授权认证概述》笔记](/分布式微服务/Authorization-Certification/Authorization-Overview)的“JWT 令牌”章节
