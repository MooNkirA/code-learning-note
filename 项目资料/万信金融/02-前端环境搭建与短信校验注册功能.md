...
用户注册功能涉及到操作数据库，本项目的数据访问层采用的是 Mybatis-Plus 框架。入门与基础使用详见[《MyBatis-Plus 基础笔记》](/后端框架/MyBatis/MyBatis-Plus)
...
本项目的远程调用是使用 Spring Cloud OpenFeign 进行模板化 HTTP 请求，具体 Feign 使用详见[《Spring Cloud OpenFeign 服务调用》](/分布式微服务/SpringCloud/Spring-Cloud-OpenFeign)
