...
> Notes: 以上 `@ConditionalXxx` 注解是 Spring Boot 特有的条件依赖注解，具体的介绍与用法详见[《Spring Boot 注解汇总》笔记](/分布式微服务/SpringBoot/SpringBoot-注解汇总)
...
> 更多自定义 starter 细节详见[《Spring Boot 基础篇》笔记](/分布式微服务/SpringBoot/SpringBoot-基础篇)的“自定义 starter”章节
