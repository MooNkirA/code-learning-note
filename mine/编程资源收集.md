...
- [Build Your Own X](https://github.com/danistefanovic/build-your-own-x)。该库收集了诸多优质资源，教你如何构建一些属于自己的东西，内容主要分为增强现实、区块链、机器人、编辑器、命令行工具、神经网络、操作系统等几大类别。
...
- [Coding Interview University](https://github.com/jwasham/coding-interview-university)，国外大佬整理的个人学习手册
- [System Design Primer](https://github.com/donnemartin/system-design-primer)，学习如何设计可扩展的系统
