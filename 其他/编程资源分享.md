...
- [二进制跳动 大厂面试专栏](https://offercome.cn/) - Java生态圈常用技术框架、开源中间件，Spring 全家桶、分布式架构、团队管理、大厂面试题、职场锦囊、读书单、个人成长、思考等知识
...
- [Java Core Sprout](https://crossoverjie.top/JCSprout/) - 处于萌芽阶段的 Java 核心知识库。
- [深入架构原理与实践](https://www.thebyte.com.cn/) - 这是一本关于架构设计的开源书籍。
