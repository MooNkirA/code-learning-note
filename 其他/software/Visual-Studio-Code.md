...
![](images/51617261875121.png)

可以针对全局、文件或者某个语言进行代码片段配置

![](images/413846358999181.png)

新建一个配置文件，然后就能看到如下的注释介绍
...
- `body`：代码片段的详细代码体。使用数组描述，一个子项，就是一行。可以使用 `\n` | `\t` 等，但是写多了很乱，所以很少用。
...
此扩展已经成为 VSCode 的一个本地功能(可以不安装)。直接修改 settings.json 文件开启即可
