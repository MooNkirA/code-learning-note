...
#### 7.2.3. 线程同步机制的作用：保证只有一个线程进入被同步的代码

1. 同步代码块
2. 同步方法

### 7.3. synchronized 关键字实现线程安全
#### 7.3.1. synchronized 同步代码块（方式1）
##### 7.3.1.1. 同步代码块格式
...
### 7.5. Lock 和 synchronized 的区别与选择
#### 7.5.1. synchronized 和 ReentrantLock 的区别
...
## 10. ThreadLocal 类（线程本地存储）

### 10.1. ThreadLocal 的概念
...
### 11.1. 为什么 wait, notify, notifyAll 等方法都定义在 Object 类中
