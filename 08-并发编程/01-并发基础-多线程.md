...
- 唤醒一个线程池中调用了 `wait()` 方法的线程，而且是随机唤醒一个。注意，唤醒的线程之间必须是同一个锁
...
## 13. ThreadLocal 类（线程本地存储）

### 13.1. ThreadLocal 的概念
...
### 14.1. 为什么 wait, notify, notifyAll 等方法都定义在 Object 类中
