...
### 2.7. （整理中）ScheduledThreadPoolExecutor

> 参考：https://www.pdai.tech/md/java/thread/java-thread-x-juc-executor-ScheduledThreadPoolExecutor.html
...
`submit()` 和 `execute()` 两个方法都可以向线程池提交任务。主要区别如下：
