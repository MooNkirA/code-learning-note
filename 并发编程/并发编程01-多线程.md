...
#### 7.2.1. 情况 1 NEW --> RUNNABLE

当调用 `t.start()` 方法时，由 `NEW --> RUNNABLE`

#### 7.2.2. 情况 2 RUNNABLE <--> WAITING
...
#### 8.3.4. sleep(long n) 和 wait(long n) 的区别
...
### 8.5. park/unpark 与 wait/notify 的区别
...
## 9. AbstractQueuedSynchronizer （AQS）
...
#### 9.1.2. AQS(AbstractQueuedSynchronizer)原理图
...
## 11. ThreadLocal 类（线程本地存储）

### 11.1. ThreadLocal 的概念
